...
/**
 * Implements {@link ByteArrayBuffer}. Cloned from libjitsi implementation, for testing jitsi-srtp.
 *
 * @author Boris Grozev
 */
public class ByteArrayBufferImpl implements ByteArrayBuffer {
    ...
    /**
     * Initializes a new {@link ByteArrayBufferImpl} based on a newly allocated byte array with the
     * given size.
     *
    ...
    public void grow(int howMuch) {
        if (howMuch < 0) throw new IllegalArgumentException("howMuch");
