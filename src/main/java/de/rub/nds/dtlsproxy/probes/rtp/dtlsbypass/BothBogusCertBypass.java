...
public class BothBogusCertBypass extends AuthBypass {

    public BothBogusCertBypass() {
        super(
                "present unexpected arbitrary server certificate, present unexpected arbitrary client certificate",
                true,
                true);
    }
     ...
     * and the server accepts certificates not matching the SDP fingerprint.
     *
     * <pre>
     *
     * Client                    MitM                  Server
