...
public class MimicryClientCertBogusServerCertBypass extends MimicryCertBypass {

    public MimicryClientCertBogusServerCertBypass() {
        super(
                "present unexpected arbitrary server certificate, present mimicked client certificate",
                true,
                true,
                true);
    }
     ...
     * SDP fingerprint, but looking alike the original. Also assumes the client accepts any
     * certificate
     *
     * <pre>
     *
