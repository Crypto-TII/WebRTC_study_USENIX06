...
public class BogusClientCertTrustedServerCertBypass extends TrustedCertBypass {

    public BogusClientCertTrustedServerCertBypass() {
        super(
                "present trusted server certificate, present unexpected arbitrary client certificate",
                true,
                true,
                false,
                true);
     ...
     * SDP fingerprint, but verifable through the client trust store. Also assumes that the client
