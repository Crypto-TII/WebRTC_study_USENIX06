...
import de.rub.nds.dtlsproxy.probes.dtls.DoubleCkeProcessingProbe;
...
public class DoubleCkeProcessingProbeTest extends ProbingTest {
    ...
    public void testVerifyingViaAbort() throws IOException {
        ...
        DoubleCkeProcessingProbe probe = new DoubleCkeProcessingProbe(webrtcExecutionContext);
        probe.test(report);
    ...
    public void testVerifyingViaAlert() throws IOException {
        ...
        actions =
                SimulationLibrary.remove(
                        actions, SimulationLibrary.INDEX_ID_SCCS, SimulationLibrary.INDEX_ID_CA);
        actions.add(
                SimulatedAction.alertBadCert(SimulationLibrary.INDEX_ID_CA, ConnectionSide.SERVER));
